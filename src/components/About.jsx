...
const STEPS = [
  ...
  },
  {
    n: "02",
    title: "구현한다",
    body: "Vanilla JS·React·TypeScript로 웹 앱을 만들고, Redux와 Firebase로 상태·데이터를 연결합니다.",
  },
  {
    n: "03",
    title: "배포한다",
      ...
      <div className="container about__grid">
        ...
        >
          ...
          <p className="about__body">
            ...
            프로젝트에서 프론트엔드를 담당했고, 바닐라 JavaScript SPA부터
            React·TypeScript 앱까지 다양한 스택으로 웹 서비스를 구현했습니다.
          </p>
          <p className="about__body">
